...
namespace ShoppingBuyAll.clases
{
    class AccesoBD
    {
        ...
        string cadena_conexion = "Provider=SQLNCLI11;Data Source=DESKTOP-Q1570T7;Integrated Security=SSPI;Initial Catalog=Shopping_Buy_All";
